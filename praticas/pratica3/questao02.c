/*
2. Faca um programa em C que calcule o valor do desconto
   sobre um valor bruto lido com base na escala: até de 
  100.00 aplica 1%; de 100.01 a 500.00 aplica 5%; acima de 500.00 aplica 10%
*/
#include <stdio.h>
...
int main() {
  ...
  printf("Entre com o valor bruto: R$");
